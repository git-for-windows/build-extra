...
; - 메시지 끝에 마침표 (.)나 콜론 (:) 또는 말줄임표 (...)을 추가하지 마세요.
; - 메시지 끝에서 마침표, 콜론, 말줄임표 또는 물음표를 제거하지 마세요.
...
SetupFileCorrupt=설치 파일이 손상되었습니다. 프로그램의 새 사본을 받으세요.
...
PrivilegesRequiredOverrideText1=%1은(는) 모든 사용자 (관리자 권한 필요) 또는 현재 사용자용으로만 설치할 수 있습니다.
PrivilegesRequiredOverrideText2=%1은(는) 현재 사용자용으로만 또는 모든 사용자 (관리자 권한 필요)용으로 설치할 수 있습니다.
...
PrivilegesRequiredOverrideCurrentUserRecommended=현재 사용자용으로만 설치 (권장)(&M)
...
ExitSetupMessage=설치가 완료되지 않았습니다. 지금 종료하면 프로그램이 설치되지 않습니다.%n%n나중에 설치를 다시 실행하여 설치를 완료할 수 있습니다.%n%n설치를 종료하시겠습니까?
...
DiskSpaceGBLabel=최소 [gb] GB의 디스크 여유 공간이 필요합니다.
DiskSpaceMBLabel=최소 [mb] MB의 디스크 여유 공간이 필요합니다.
CannotInstallToNetworkDrive=네트워크 드라이브에 설치할 수 없습니다.
CannotInstallToUNCPath=UNC 경로에 설치할 수 없습니다.
InvalidPath=드라이브 문자를 포함한 전체 경로를 입력해야 합니다. 예:%n%nC:\App%n%n또는 UNC 경로 형식:%n%n\\server\share
InvalidDrive=선택한 드라이브 또는 UNC 공유가 존재하지 않거나 액세스할 수 없습니다. 다른 것을 선택하세요.
DiskSpaceWarningTitle=디스크 공간이 부족합니다
DiskSpaceWarning=설치 시 최소 %1 KB의 여유 공간이 필요하지만, 선택한 드라이브의 여유 공간은 %2 KB밖에 없습니다.%n%n그래도 계속하시겠습니까?
...
CompactInstallation=간단 설치
CustomInstallation=사용자 지정 설치
NoUninstallWarningTitle=구성 요소가 존재합니다
NoUninstallWarning=설치 프로그램에서 다음 구성 요소가 컴퓨터에 이미 설치되어 있음을 감지했습니다:%n%n%1%n%n이러한 구성 요소를 선택 해제해도 제거되지 않습니다.%n%n그래도 계속하시겠습니까?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
ComponentsDiskSpaceGBLabel=현재 선택은 최소 [gb] GB의 디스크 공간이 필요합니다.
ComponentsDiskSpaceMBLabel=현재 선택은 최소 [mb] MB의 디스크 공간이 필요합니다.
...
SelectStartMenuFolderLabel3=설치 프로그램은 다음 시작 메뉴 폴더에 프로그램 바로 가기를 만듭니다.
...
ReadyLabel1=지금 [name]을(를) 컴퓨터에 설치할 준비가 되었습니다.
...
ArchiveIsCorrupted=압축 파일이 손상되었습니다
ArchiveUnsupportedFormat=압축 파일 형식이 지원되지 않습니다

; *** "Preparing to Install" wizard page
WizardPreparing=설치 준비 중
PreparingDesc=컴퓨터에 [name] 설치를 준비하는 중입니다.
PreviousInstallNotCompleted=이전 프로그램의 설치/제거가 완료되지 않았습니다. 설치를 완료하려면 컴퓨터를 다시 시작해야 합니다.%n%n컴퓨터를 다시 시작한 후 설치를 다시 실행하여 [name] 설치를 완료하세요.
...
ErrorCloseApplications=모든 응용 프로그램을 자동으로 닫지 못했습니다. 계속하기 전에 설치 프로그램에서 업데이트해야 하는 파일을 사용하는 모든 응용 프로그램을 닫는 것이 좋습니다.
...
ErrorExtracting=압축 파일을 추출하는 동안 오류 발생:
...
ErrorRegSvr32Failed=RegSvr32가 종료 코드 %1(으)로 실패했습니다
...
UninstallUnknownEntry=제거 로그에 알 수 없는 항목 (%1)이(가) 있습니다
ConfirmUninstall=%1 및 해당 구성 요소를 모두 완전히 제거하시겠습니까?
...
UninstalledMost=%1 제거가 완료되었습니다.%n%n일부 요소를 제거할 수 없었습니다. 수동으로 제거할 수 있습니다.
...
ProgramOnTheWeb=웹상의 %1
UninstallProgram=%1 제거
LaunchProgram=%1 실행
AssocFileExtension=%1을(를) %2 파일 확장자에 연결(&A)
AssocingFileExtension=%1을(를) %2 파일 확장자와 연결하는 중...
AutoStartProgramGroupDescription=시작:
AutoStartProgram=%1 자동 시작
AddonHostProgramNotFound=%1을(를) 선택한 폴더에서 찾을 수 없습니다.%n%n그래도 계속하시겠습니까?
