...
CannotContinue=Installationsprogrammet kan ikke fortsætte. Klik venligst på Annuller for at afslutte.
...
PrepareToInstallNeedsRestart=Installationsprogrammet er nødt til at genstarte computeren. Efter genstarten skal du køre installationsprogrammet igen for at færdiggøre installation af [name].%n%nVil du genstarte nu?
...
ErrorDownloading=Der opstod en fejl ved forsøg på at downloade en fil:
