...
AboutSetupNote=
TranslatorNote=Catalan translation by Carles Millan (carles at carlesmillan.cat) and Artur Vicedo (artur at softcatala.org)
...
DownloadingLabel2=Descarregant els fitxers addicionals...
...
ExtractingLabel=Extraient els fitxers addicionals...
...
ArchiveIsCorrupted=El arxiu es troba corrupte
ArchiveUnsupportedFormat=El format del arxiu no és compatible
...
RetryCancelSelectAction=Seleccioneu una acció
RetryCancelRetry=&Torna a provar-ho
RetryCancelCancel=Cancel·la

; *** Installation status messages
StatusClosingApplications=Tancant aplicacions...
StatusCreateDirs=Creant carpetes...
StatusExtractFiles=Extraient fitxers...
StatusDownloadFiles=Descarregant fitxer...
...
VerificationFileTagIncorrect=L'etiqueta del fitxer no és correcta
...
ErrorDownloading=Hi ha hagut un error en baixar un fitxer:
ErrorExtracting=Hi ha hagut un error en extraure un arxiu:
