...
DiskSpaceWarning=דרוש לפחות %1KB שטח דיסק פנוי להתקנה, אך לכונן שנבחר יש רק %2KB זמינים.%n%nהאם ברצונך להמשיך למרות זאת?
...
NoUninstallWarning=תוכנת ההתקנה זיהתה שהרכיבים הבאים כבר מותקנים על מחשבך:%n%n%1%n%nהסרת הסימון מרכיבים אלו לא תסיר אותם ממחשבך.%n%nהאם ברצונך להמשיך בכל זאת?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
...
ErrorProgress=תהליך לא חוקי: %1 מתוך %2
ErrorFileSize=גודל קובץ לא חוקי: מצופה %1, נמצא %2
