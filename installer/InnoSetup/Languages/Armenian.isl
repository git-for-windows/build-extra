...
ExitSetupMessage=Տեղակայումը չի ավարտվել։ Եթե ընդհատեք, ապա ծրագիրը չի տեղադրվի։%n%nԱվարտե՞լ։
...
DirExists=%n%n%1%n%nպանակը արդեն գոյություն ունի։ Այնուհանդերձ, տեղադրե՞լ այստեղ։
DirDoesntExistTitle=Պանակը գոյություն չունի
DirDoesntExist=%n%n%1%n%nպանակը գոյություն չունի։ Ստեղծե՞լ այն։
...
SelectStartMenuFolderBrowseLabel=Սեղմեք «Հաջորդ»՝ շարունակելու համար։ Եթե ցանկանում եք ընտրել այլ պանակ՝ սեղմեք «Ընտրել»։
...
FinishedRestartMessage=[name]-ի տեղադրումը ավարտելու համար պետք է վերամեկնարկել համակարգիչը։%n%nՎերամեկնարկե՞լ հիմա։
...
StatusDownloadFiles=Ֆայլերի ներբեռնում...
...
FileExists2=Ֆայլն արդեն գոյություն ունի։
