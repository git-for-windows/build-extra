...
ApplicationsFound=แอพลิเคชั่นดังต่อไปนี้กำลังใช้ไฟล์ที่จำเป็นต้องถูกอัพเดทโดยตัวติดตั้ง ขอแนะนำให้คุณอนุญาตตัวติดตั้งในการปิดแอพลิเคชั่นเหล่านี้โดยอัตโนมัติ
ApplicationsFound2=แอพลิเคชั่นดังต่อไปนี้กำลังใช้ไฟล์ที่จำเป็นต้องถูกอัพเดทโดยตัวติดตั้ง ขอแนะนำให้คุณอนุญาตตัวติดตั้งในการปิดแอพลิเคชั่นเหล่านี้โดยอัตโนมัติ หลังจากการติดตั้งเสร็จสิ้น ตัวติดตั้งจะพยายามรีสตาร์ทแอพลิเคชั่นเหล่านั้น
CloseApplications=&ปิดแอพลิเคชั่นโดยอัตโนมัติ
