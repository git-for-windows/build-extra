...
SetupFileMissing=U schedariu %1 manca in u cartulare d’installazione. Ci vole à currege u prublemu o ottene una copia nova di u prugramma.
SetupFileCorrupt=I schedarii d’installazione sò alterati. Ci vole à ottene una copia nova di u prugramma.
SetupFileCorruptOrWrongVer=I schedarii d’installazione sò alterati, o sò incumpatibuli cù sta versione di l’assistente. Ci vole à currege u prublemu o ottene una copia nova di u prugramma.
...
PrivilegesRequiredOverrideText1=%1 pò esse installatu per tutti l’utilizatori (richiede i diritti d’amministratore), o solu per voi.
PrivilegesRequiredOverrideText2=%1 pò esse installatu solu per voi, o per tutti l’utilizatori (richiede i diritti d’amministratore).
...
ExitSetupTitle=Esce da l’assistente
ExitSetupMessage=L’assistente ùn hè micca compiu bè. S’è voi escite avà, u prugramma ùn serà micca installatu.%n%nPudete impiegà l’assistente torna un’altra volta per compie l’installazione.%n%nEsce da l’assistente ?
...
; *** Common wizard text
ClickNext=Sceglie Seguente per cuntinuà, o Abbandunà per esce da l’assistente.
BeveledLabel=
...
PasswordLabel3=Ci vole à pruvede a parolla d’intesa, eppò sceglie Seguente per cuntinuà. E parolle d’intesa sò sensibile à a cassa.
...
CannotInstallToNetworkDrive=L’assistente ùn pò micca installà nant’à un lettore di a reta.
...
InvalidDrive=U lettore o u chjassu UNC spartu chì vo avete selezziunatu ùn esiste micca o ùn hè micca accessibule. Ci vole à selezziunane un altru.
...
SelectComponentsLabel2=Selezziunà i cumpunenti à installà ; squassà quelli ch’ùn devenu micca esse installati. Sceglie Seguente quandu site prontu à cuntinuà.
...
ComponentSize1=%1 Ko
ComponentSize2=%1 Mo
ComponentsDiskSpaceGBLabel=A selezzione attuale richiede omancu [gb] Go di spaziu nant’à u discu.
ComponentsDiskSpaceMBLabel=A selezzione attuale richiede omancu [mb] Mo di spaziu nant’à u discu.

; *** "Select Additional Tasks" wizard page
WizardSelectTasks=Selezziunà trattamenti addizziunali
SelectTasksDesc=Chì trattamenti addizziunali vulete fà ?
SelectTasksLabel2=Selezziunà i trattamenti addizziunali chì l’assistente hà da fà durante l’installazione di [name], eppò sceglie Seguente.

; *** "Select Start Menu Folder" wizard page
WizardSelectProgramGroup=Selezziunà u cartulare di u listinu « Démarrer »
...
ReadyLabel2a=Sceglie Installà per cuntinuà l’installazione, o fà un cliccu nant’à Precedente per rivede o cambià qualchì parametru.
...
ErrorDownloadFailed=Fiascu di u scaricamentu : %1 %2
...
ExtractingLabel=Estrazzione di i schedarii…
...
ClickFinish=Sceglie Piantà per esce da l’assistente.
...
ShowReadmeCheck=Iè, vogliu leghje u schedariu LISEZMOI
YesRadio=&Iè, rilancià l’urdinatore subitu
NoRadio=&Nò, preferiscu rilancià l’urdinatore dopu
...
PathLabel=&Chjassu :
FileNotInDir2=U schedariu « %1 » ùn si trova micca in « %2 ». Mittite u discu currettu o sciglite un altru cartulare.
SelectDirectoryLabel=Ci vole à specificà induve si trova u discu seguente.

; *** Installation phase messages
SetupAborted=L’installazione ùn s’hè micca compia bè.%n%nCi vole à currege u prublemu è eseguisce l’assistente torna.
AbortRetryIgnoreSelectAction=Selezziunà un’azzione
...
StatusSavingUninstall=Cunservazione di l’infurmazioni di disinstallazione…
StatusRunProgram=Cumpiera di l’installazione…
StatusRestartingApplications=Relanciu di l’appiecazioni…
StatusRollback=Annulazione di i cambiamenti…
...
; *** File copying errors
FileAbortRetryIgnoreSkipNotRecommended=&Tralascià stu schedariu (micca ricumandatu)
...
ErrorRestartReplace=Fiascu di rilanciu o di rimpiazzamentu :
ErrorRenamingTemp=Un sbagliu hè accadutu pruvendu di rinuminà un schedariu in u cartulare di destinazione :
ErrorRegisterServer=Impussibule d’arregistrà a DLL/OCX : %1
...
ErrorOpeningReadme=Un sbagliu hè accadutu pruvendu d’apre u schedariu LISEZMOI.
...
UninstallUnknownEntry=Un elementu scunnisciutu (%1) hè statu trovu in u ghjurnale di disinstallazione
...
OnlyAdminCanUninstall=St’appiecazione pò esse disinstallata solu da un utilizatore cù i diritti d’amministratore.
...
UninstalledMost=A disinstallazione di %1 hè compia.%n%nQualchì elementu ùn pò micca esse cacciatu. Si pò cacciallu manualmente.
...
AddonHostProgramNotFound=Impussibule di truvà %1 in u cartulare selezziunatu.%n%nVulete cuntinuà quantunque ?
