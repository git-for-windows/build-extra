...
ExitSetupMessage=لم يكتمل الإعداد. إذا قمت بالخروج الآن، لن يتم تثبيت البرنامج.%n%nيمكنك تشغيل برنامج الإعداد مرة أخرى في وقت آخر لإكمال التثبيت.%n%nإنهاء الإعداد؟
...
InvalidPath=يجب إدخال مسار كامل مع حرف محرك الأقراص; على سبيل المثال:%n%nC:\APP%n%nأو مسار UNC في النموذج:%n%n\\server\share
...
DirExists=المجلد:%n%n%1%n%nموجود بالفعل. هل ترغب في التثبيت على هذا المجلد على أي حال؟
