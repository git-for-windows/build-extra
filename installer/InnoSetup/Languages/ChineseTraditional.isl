...
WelcomeLabel2=這個安裝程式將會安裝 [name/ver] 到您的電腦。%n%n建議您在繼續之前關閉所有其他的應用程式。
...
; *** Registry errors
ErrorRegOpenKey=無法開啟登錄機碼：%n%1\%2
ErrorRegCreateKey=無法建立登錄機碼：%n%1\%2
ErrorRegWriteKey=無法變更登錄機碼：%n%1\%2
