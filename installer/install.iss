...
begin
    ...
    RdbGitCredentialManager[GCM_Core]:=CreateRadioButton(GitCredentialManagerPage,'Git Credential Manager Core','<RED>(NEW!)</RED> Use the new, <A HREF=https://github.com/microsoft/Git-Credential-Manager-Core>cross-platform version of the Git Credential Manager</A>.'+#13+'See more information about the future of Git Credential Manager <A HREF=https://github.com/microsoft/Git-Credential-Manager-Core/blob/master/docs/faq.md#about-the-project>here</A>. (requires .NET framework v4.6.1 or later)',TabOrder,Top,Left);
    ...
    // Deactivate if each GCM doesn't meet their Fx version requirement.
    if DetectNetFxVersion()<394254 then begin
