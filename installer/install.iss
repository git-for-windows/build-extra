...
Filename: "schtasks"; Description: Daily check for available update using git http.proxy if defined; Parameters: "/Create /F /SC DAILY /TN ""Git for Windows Updater"" /TR ""'{app}\bin\git.exe' update"""; Flags: runhidden postinstall
