# Git for Windows v2.16.2 Release Notes
Latest update: February 20th 2018
...
* Comes with [gawk v4.2.1](http://git.savannah.gnu.org/cgit/gawk.git/plain/NEWS?h=gawk-4.2.1/CHANGES).
